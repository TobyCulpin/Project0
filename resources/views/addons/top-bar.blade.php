<div class="top-bar">
        <ul class="container">
                <li class="item">
                        <a id="adminIcon" href="/admin">
                                <?xml version="1.0" encoding="iso-8859-1"?>
                                <!-- Generator: Adobe Illustrator 19.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512"
                                        style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                        <path style="fill:#00bb00;" d="M321.629,446.371c-63.337,0-122.346-31.371-157.846-83.916c-7.196-10.651-4.395-25.117,6.254-32.313
                                        ...
                                        <path style="fill:#22dd22;" d="M368.428,268.94c0.092-0.133,0.164-0.278,0.251-0.414c0.324-0.504,0.639-1.013,0.925-1.542
